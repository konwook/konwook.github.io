<script lang="ts">
    ...
    onMount(async () => {
      const resp = await fetch(
        "https://api.github.com/users/konwook/repos?per_page=100"
      );
  ...
  <Seo
    title="Konwoo Kim – Projects"
    description="Software and research projects in systems, computer graphics, and machine learning."
  />
